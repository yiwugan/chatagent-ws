...
# web socket security
APP_CONNECTION_MAX_SESSIONS_PER_IP = int(os.getenv("APP_CONNECTION_MAX_SESSIONS_PER_IP", 10))
APP_CONNECTION_MAX_REQUESTS_PER_MINUTE = int(os.getenv("APP_CONNECTION_MAX_REQUESTS_PER_MINUTE", 30))
APP_SECURITY_TOKEN_EXPIRY_SECONDS = int(os.getenv("APP_SECURITY_TOKEN_EXPIRY_SECONDS", 600))
